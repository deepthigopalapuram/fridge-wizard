...
# -----------------------------------------------------------
# PAGE CONFIGURATION & BRANDING OVERRIDE
# -----------------------------------------------------------
st.set_page_config(
...
# Forces mobile/desktop browser tabs to show WhatToCook instead of Streamlit
components.html(
    """
    <script>
        ...
        links.forEach(link => {
            link.href = "https://abs.twimg.com/emoji/v2/72x72/1f373.png";
        });
    </script>
""",
    height=0,
...
RECIPES = [
    {
        ...
        "difficulty": "Easy",
        "instructions": (
            "1. Chop potatoes and capsicum into cubes.\n2. Sauté onions and"
            " tomatoes with Indian spices in oil.\n3. Add potatoes and"
            " capsicum, cover and cook until tender."
        ),
    },
    {
        ...
        "difficulty": "Easy",
        "instructions": (
            "1. Slice capsicum and onions lengthwise.\n2. Sauté onions in oil,"
            " add sliced capsicum and spices, and cook for 5 minutes.\n3."
            " Sprinkle roasted gram flour (besan) on top for an amazing crunch"
            " and aroma!"
        ),
    },
    {
        ...
        "difficulty": "Medium",
        "instructions": (
            "1. Boil lentils (dal) with turmeric.\n2. In a separate pan, temper"
            " garlic, onions, tomatoes, and chopped palak.\n3. Mix the cooked"
            " dal into the spinach tempering and simmer."
        ),
    },
    {
        "title": "Methi Paratha",
        ...
        "difficulty": "Easy",
        "instructions": (
            "1. Wash and finely chop fresh methi leaves.\n2. Mix with wheat"
            " flour, salt, and spices, then knead into a soft dough.\n3. Roll"
            " into flatbreads (parathas) and cook on a hot tawa with oil or"
            " ghee."
        ),
    },
    {
        ...
        "difficulty": "Medium",
        "instructions": (
            "1. Roast the brinjal directly over a flame until soft, peel the"
            " skin, and mash it.\n2. Sauté chopped onions, garlic, and tomatoes"
    ...
    },
    {
        ...
        "difficulty": "Medium",
        "instructions": (
            "1. Slice bitter gourd thinly and rub with salt (optional to reduce"
            " bitterness).\n2. Heat oil in a pan, add sliced onions and spices.\n3."
            " Fry the bitter gourd on medium heat until crispy and golden."
        ),
    },
    {
        ...
        "instructions": (
            ...
            " and tomatoes with basic Indian spices.\n3. Add bottle gourd"
            " pieces, cover, and cook until soft and juicy."
        ),
    },
    {
        ...
        "difficulty": "Easy",
        "instructions": (
            "1. Blend fresh mint leaves into a coarse paste.\n2. Sauté sliced"
            " onions and spices in oil, then add the mint paste.\n3. Toss in"
            " cooked rice and mix thoroughly on low heat."
        ),
    },
    {
        ...
        "difficulty": "Medium",
        "instructions": (
            "1. Boil pre-soaked rajma until completely soft.\n2. Sauté garlic,"
            " onions, and tomatoes with rich Indian spices to make a thick"
            " gravy.\n3. Add boiled rajma, simmer together for 10 minutes, and"
            " serve hot with rice."
        ),
    },
]
